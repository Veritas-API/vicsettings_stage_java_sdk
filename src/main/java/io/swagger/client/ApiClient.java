...
public class ApiClient {
    ...
    private String basePath = "http://veritas-nonprod-stage.apigee.net/vic/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://veritas-nonprod-stage.apigee.net/vic/v1
